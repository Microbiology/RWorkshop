---
title: "GtvAndDermRWorkshop"
output: html_document
---

This is an R markdown file of the R workshop notes. This shows both the code and the output after it is run in R. The shaded regions are the code as written in the **GtvAndDermRWorkshop.R** file. The white boxes how the output as seen in R. The plots generated are also shown in the markdown folder.
